...
const sortNames = (arr) => {
    ...
    {
      let itemToPush = arr[i] > arr[i+1] ? arr[i+1] : arr[i];
...
const alphabetize = (arr) => {
  ...
  for(let i=0;i<arr.length;i++) {
    let pointer = arr.length - 1;
    while(i <= pointer){
      if(arr[i].charAt(0) > arr[pointer].charAt(0)){
        let temp = arr[i];
        arr[i] = arr[pointer];
        arr[pointer] = temp;
      }
...
const sortByPrice = (arr) => {
  ...
  for(let i=0;i<arr.length;i++){
    let pointer = arr.length -1;
    while(i <= pointer){
      if(arr[i].price > arr[pointer].price){
        let temp = arr[i];
        arr[i] = arr[pointer];
        arr[pointer] = temp;
      }
...
const sortByLength = (arr) => {
  ...
  for(let i=0;i<arr.length;i++){
    let pointer = arr.length - 1;
    while(i <= pointer){
      let iStringLength = arr[i].length;
      let pStringLength = arr[pointer].length;
      if(iStringLength > pStringLength){
        let temp = arr[i];
        arr[i] = arr[pointer];
        arr[pointer] = temp;
      }
