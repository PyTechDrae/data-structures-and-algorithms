...
const listFoods = (recipe) => {
  ...
  let matchArr = [...gruffaloCrumble.ingredients[i].matchAll(' ')];
  let targetSpaceIdx = matchArr[1].index;
  let temp = gruffaloCrumble.ingredients[i].substring(targetSpaceIdx+1);
  result.push(temp);
}  
  return result;
};
